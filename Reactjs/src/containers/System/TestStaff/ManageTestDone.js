...
import { getTestDone } from '../../../services/userService';
...
class DefaultClass extends Component {
    ...
    render() {
        let {currentDate, dataTestbyId, isOpenTestStaffModal, dataTestStaffResult} = this.state
        return (
            ...
            <SeeTestFromStaffModal 
                    isOpenModal= {isOpenTestStaffModal}
                    dataTestStaffResult={dataTestStaffResult}
